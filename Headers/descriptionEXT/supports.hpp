#if __has_include("KISKA Systems\Headers\Support Framework\basic supports.hpp")
    #include "KISKA Systems\Headers\Support Framework\basic supports.hpp"
#else
    #if __has_include("\KISKA_Functions\Headers\Support Framework\basic supports.hpp")
    ...
    #if __has_include("\KISKA_Functions\Headers\Support Framework\Support Type IDs.hpp")
        #include "\KISKA_Functions\Headers\Support Framework\Support Type IDs.hpp"
    #endif

    #if __has_include("\KISKA_Functions\Headers\Support Framework\Support Icons.hpp")
        #include "\KISKA_Functions\Headers\Support Framework\Support Icons.hpp"
    #endif

    #if __has_include("\KISKA_Functions\Headers\Support Framework\CAS Type IDs.hpp")
        #include "\KISKA_Functions\Headers\Support Framework\CAS Type IDs.hpp"
    #endif

    #if __has_include("\KISKA_Functions\Headers\Support Framework\Arty Ammo Type IDs.hpp")
        #include "\KISKA_Functions\Headers\Support Framework\Arty Ammo Type IDs.hpp"
    #endif
